(function($){
    ...
    function onSubmitForm(e){
        ...
        $.ajax({
            url: 'https://jewelersapi.uat.premierdesigns.com/wix/validateEmail/' + jewelerId + '?email=' + encodeURIComponent(email),
            method: 'GET',
            dataType: 'json',
            crossDomain: true,
            async: false
        ...
        //call api
        $.ajax({
            url: 'https://jewelersapi.uat.premierdesigns.com/wix/processJrcPayment',
            method: 'POST',
            dataType: 'json',
