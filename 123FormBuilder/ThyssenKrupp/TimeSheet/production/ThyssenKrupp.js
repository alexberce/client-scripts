(function(){
	var
		startTimeFieldId = 435146,
		finishTimeFieldId = 435147,
		hoursWorkedFieldId = 435150,
		
		expensesPoundsFieldId = 435151,
		expensesCodeFieldId = 435152,
		
		radiusMilesFieldId = 435153,
		nightRatePaymentFieldId = 435154,
		
		/**
		 * HTML Block Fields
		 */
		
		topHTMLBlockFieldId = 435145,
		bottomHTMLBlockFieldId = 435155,
		
		/**
		 * Utility Fields
		 */
		
		mileageRateFieldId = 435160,
		administrationCodesFieldId = 435161,
		administrationCodePriceFieldId = 435163,
		...
		for(var repeatedIndex = 0; repeatedIndex < numberOfRowsToAdd; repeatedIndex++){
			try {
				...
				if(
					...
					&& typeof mileageRateField !== 'undefined'
				){
